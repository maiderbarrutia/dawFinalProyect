    ...
    const INITIAL_ACTIVITIES = [
        {
            ...
            company_id: 1,
            activity_date: new Date('2025-08-01'),
        ...
        },
        {
            ...
            company_id: 2,
            activity_date: new Date('2025-10-02'),
        ...
        },
        {
            ...
            company_id: 5,
            activity_date: new Date('2025-09-10'),
    ...
    try {
        for (const activity of INITIAL_ACTIVITIES) {
            ...
            if (!existingActivity) {
                ...
                const hasChanges = (existingActivity.activity_title !== activity.activity_title ||
